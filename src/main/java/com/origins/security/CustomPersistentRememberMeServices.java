...
public class CustomPersistentRememberMeServices extends AbstractRememberMeServices {
    ...
    @Inject
    public CustomPersistentRememberMeServices(OriginsProperties originsProperties, org.springframework.security.core.userdetails
            .UserDetailsService userDetailsService) {

        super(originsProperties.getSecurity().getRememberMe().getKey(), userDetailsService);
