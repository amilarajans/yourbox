...
package com.origins.configuration.locale;
        ...
        if (request.getAttribute(LOCALE_REQUEST_ATTRIBUTE_NAME) == null) {
            ...
            if (cookie != null) {
                ...
                if (logger.isTraceEnabled()) {
                    logger.trace(String.format("Parsed cookie value [%s] into locale '%s'%s", cookie.getValue(), locale, timeZone != null ? " and time zone '" + timeZone.getID() + "'" : ""));
                }
            }
